...
/***************************删除列车数据***********************/
bool DataBase::deleteTrainData(QString trainNumber, QString startTime, QString endTime)
{
    ...
    QString str = QString("delete from traininfo where trainnumber = '") + trainNumber + "' and ";

    str += "starttime = '" + startTime + "' and endtime = '" + endTime+ "';";
...
bool DataBase::insertUserData(UserInfo & userInfo)
{
    ...
    str += userInfo.idCardNumber  + "','" + userInfo.name   + "','";

    str += userInfo.trainNumber   + "','";
...
int DataBase::selectUserData(int type, QString data)
{
    ...
    while(query.next())        //挨个遍历数据
    {
        ...
        userInfo.name          = query.value(GLOBALDEF::USERNAME).toString();
...
/***************************删除列车数据***********************/
bool DataBase::deleteUserData(QString idCardNumber, QString dateTime)
{
    ...
    QString str = QString("delete from userinfo where idcardnumber = '") + idCardNumber + "'  and datatime ='" + dateTime + "';";
